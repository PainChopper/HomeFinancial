...
public interface ITransactionRepository
{
    ...
    Task<(int InsertedCount, int SkippedDuplicateCount)> BulkInsertCopyAsync(IList<BulkTransactionDto> transactions, CancellationToken cancellationToken = default);
}
